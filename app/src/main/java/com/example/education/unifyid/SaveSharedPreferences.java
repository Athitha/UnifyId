...
/**
 * Created by Athitha Anantharamu on 6/28/17.
 */
...
public class SaveSharedPreferences {
    ...
    private static SaveSharedPreferences instance = null;

    public SaveSharedPreferences(Context context, String preferenceName,
    ...
    public static SaveSharedPreferences getInstance(Context contxt,String prefName) {
        if (instance == null) {
            instance = new SaveSharedPreferences(contxt, prefName,
                    prefName+"Key", true);
        }
        return instance;
    }
